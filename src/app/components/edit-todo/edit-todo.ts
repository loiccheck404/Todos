...
export class EditTodoComponent implements OnInit {
  ...
  private loadTodoData() {
    ...
    if (this.todo.dueDate) {
      ...
      timeStr = dueDate.toTimeString().slice(0, 5); // HH:MM format
    }
  ...
  onSubmit() {
    ...
    if (this.editData.dueDate) {
      const dateStr = this.editData.dueDate;
      const timeStr = this.editData.dueTime || '23:59';
